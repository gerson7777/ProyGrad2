              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Consulta de Catedraticos por Grados</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        ...
                        <div class="form-inline col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select name="idcatedratico" id="idcatedratico" class="form-control selectpicker" data-live-search="true" required>                         	
                          </select>                          
                        </div>
                        <div class="form-inline col-lg-6 col-md-6 col-sm-6 col-xs-12">
                          <label>Grado</label>
...
<script type="text/javascript" src="scripts/catedraticogrado.js"></script>
